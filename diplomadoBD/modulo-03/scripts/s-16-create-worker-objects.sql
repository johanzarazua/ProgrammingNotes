...
--@Descripción: Creacion de tablas y registros en workers

-- Hace uso de variable de sustitucion definida en el script que lo invoca: s-15-create-worker.sql
-- La variable se llama p_user 

-- Para el caso de usar parametros 
-- define p_user = &1
...
prompt creando objetos para similar carga de datos

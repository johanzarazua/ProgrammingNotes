...
--@Descripción: Monitoreo de las areas de memoria
...
-- los dos .. desespues de la variable tienen el siguiente significado
-- el primer punto indica donde acaba la varibale
-- el segundo punto es el correspondiente del esquema
...
prompt mostrando datos de memoria iniciales

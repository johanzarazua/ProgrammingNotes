...
imp_h:
	imprimir_hora_num MSG

endm

imprimir_hora_num macro mensaje
	MOV CX,2D
	MOV BX,0D
	MOV AH,02H
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	cmp dx,5
	jae boton_1_1 ;Salta si dx es mayor o igual a 5
	jmp mouse_no_clic
...
boton_1_1:
	cmp dx,7
	jbe boton_1_2 ;salta si cx es menor o igual a 7
	jmp mouse_no_clic
boton_1_2:
	cmp cx,25
...
boton_1_3:
	cmp cx, 30
	jbe boton_1_4 ;salta si cx es menor o igual a 30
	jmp mouse_no_clic
boton_1_4:
	clear
